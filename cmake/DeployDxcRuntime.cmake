...
if(CONFIGURATION STREQUAL "Debug")
    foreach(_required_variable IN ITEMS DXCOMPILER_SOURCE DXIL_SOURCE)
        if(NOT DEFINED ${_required_variable} OR "${${_required_variable}}" STREQUAL "")
            message(FATAL_ERROR "DeployDxcRuntime.cmake requires ${_required_variable} for Debug.")
        endif()
    endforeach()
...
elseif(CONFIGURATION STREQUAL "Release")
    ...
    message(FATAL_ERROR "Unsupported DXC deployment configuration: ${CONFIGURATION}")
endif()
